...
def print_info(input_string=''):
    print('[94mMODEL_SNNBPTT_INFO|[0m', input_string)
...
class SNNBPTT3(nn.Module):
    def __init__(self,
        ...
        self.snn_res_step_num = snn_num_steps
...
if __name__ == '__main__':
    ...
    model = SNNBPTT3(layer_sizes=[784, 1000, 10], snn_num_steps=100, optimizer_name='sgd', optimizer_learning_rate=0.0001)
...
print('[91mFINISH: model_snnbptt[0m')
